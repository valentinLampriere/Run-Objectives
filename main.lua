...
include("scripts.Objectives.avoided_void")
include("scripts.Objectives.invincible")
--include("scripts.Objectives.hardened_skin")
include("scripts.Objectives.skull_crusher")